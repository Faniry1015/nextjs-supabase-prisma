...
function SignUp() {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      console.error(
        "handleSubmit: error while sending data to the server",
        error
      );
    }
  };
    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      ...
      >
        ...
        <div className="flex flex-col space-y-1">
          ...
          <input type="password" id="password" name="password"  className="text-black p-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
          required />
        </div>
        <div className="flex flex-col space-y-1">
